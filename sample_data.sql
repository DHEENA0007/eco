-- ========================================
-- Sample Data Script for 6valley E-commerce
...
-- Summary:
-- - 11 Categories (5 main + 6 sub-categories)
-- - 10 Brands (Apple, Samsung, Sony, Nike, Adidas, Dell, HP, Bose, LG, Canon)
-- - 5 Sellers (Vendors)
-- - 5 Shops
-- - 15 Products with real product images from Unsplash
--
-- All images are from online sources:
-- - Brand logos from logos-world.net
-- - Product images from unsplash.com
-- - Shop/seller avatars from ui-avatars.com
--
-- To use this script:
-- 1. Import into your database: mysql -u username -p database_name < sample_data.sql
-- 2. Or use phpMyAdmin to import this file
-- 3. Adjust AUTO_INCREMENT values if needed
