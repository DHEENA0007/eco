...
<head>
    ...
    <link rel="stylesheet" href="{{ theme_asset('assets/css/vertical-categories.css') }}"/>
    <link rel="stylesheet" href="{{ theme_asset('assets/css/amazon-header.css') }}"/>
    <style>
        :root {
    ...
    <link rel="stylesheet" href="{{ theme_asset('assets/css/color-override.css') }}"/>
...
@include('theme-views.layouts.partials._header-amazon')
