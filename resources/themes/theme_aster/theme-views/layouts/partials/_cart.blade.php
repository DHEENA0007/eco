...
@endphp
<div class="dropdown">
    <a href="{{route('shop-cart')}}" class="position-relative header-icon-gold" data-bs-toggle="dropdown" data-bs-auto-close="outside"
       aria-expanded="false">
        @php($cart=CartManager::getCartListQuery())
        <i class="bi bi-bag fs-18"></i>
        <span class="count header-badge-gold">{{$cart->count()}}</span>
    </a>
