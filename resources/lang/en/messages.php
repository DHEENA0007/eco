...
return [
	...
	"detect_location_automatically_using_gps" => "Detect location automatically using GPS",
	...
	"pincode_updated_successfully" => "Pincode updated successfully",
	"failed_to_update_pincode" => "Failed to update pincode",
	"please_enter_valid_6_digit_pincode" => "Please enter a valid 6-digit pincode",
	"something_went_wrong" => "Something went wrong",
	"updating" => "Updating",
	"pre_filled_from_your_profile" => "Pre-filled from your profile",
	"showing_stores_for_pincode" => "Showing stores for pincode",
	"change_location_from_profile" => "Change location from profile",
	"change" => "Change",
	"showing_all_stores_set_location_for_better_results" => "Showing all stores. Set location for better results",
